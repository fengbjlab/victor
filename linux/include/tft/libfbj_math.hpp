...
struct STAT {
	enum StatType { MIN,MAX,MEAN,SUM,N,TSS,TSS0,RMS,SPL_VAR,POP_VAR,SPL_SD,POP_SD,PRD,M3,SKEW,ADJ_SKEW,SEM,POP_VMR,CV,RSD,UCV,URSD,NUM_NAN,MEAN_ABS,MED_ABS,MEAN_POS,MED_POS,
		IQR,QCD,MAD,BWMV,MEDIAN,PCT001,PCT005,PCT01,PCT05,PCT1,PCT2,PCT2p5,PCT5,PCT9,PCT10,PCT20,PCT25,PCT33,PCT67,PCT75,PCT80,PCT90,PCT91,PCT95,PCT97p5,PCT98,PCT99,PCT995,PCT999,PCT9995,PCT9999,SD_LO,SD_UP,SORTED,
